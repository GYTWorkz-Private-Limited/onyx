"""
Utility functions for Async PostgreSQL DataConnector.
    ...
    **kwargs
    ...
    Example:
        async def process_batch(batch, connection):
            return await connection.copy_records_to_table(batch)
...
class AsyncConnectionPool:
    ...
    This is particularly useful for large PostgreSQL databases where you need to manage
